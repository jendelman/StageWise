...
* [Vignette 1](https://jendelman.github.io/StageWise/Vignette1.html) illustrates analysis of a single trait with a homogeneous GxE model (same genetic correlation between all environments). 

* [Vignette 2](https://jendelman.github.io/StageWise/Vignette2.html) illustrates analysis of a single trait with heterogeneous GxE covariance, which is often needed with diverse locations.

* [Vignette 3](https://jendelman.github.io/StageWise/Vignette3.html) illustrates the analysis of correlated traits under a homogeneous GxE model.
